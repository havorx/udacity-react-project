        ...
        {showSearchPage ? (
            <div className="search-books">
              <div className="search-books-bar">
                <button className="close-search"
                        onClick={() => setShowSearchPage(false)}>Close
                </button>
            ...
            <div className="list-books">
                      ...
                      <ol className="books-grid">
                        <li>
                          <div className="book">
                            ...
                            <div className="book-title">To Kill a
                              Mockingbird
                            </div>
                        ...
                        <li>
                          <div className="book">
                            ...
                            <div className="book-authors">Orson Scott Card
                            </div>
                          </div>
                        </li>
                      </ol>
                      ...
                      <ol className="books-grid">
                        <li>
                          <div className="book">
                            ...
                            <div className="book-authors">David McCullough
                            </div>
                          </div>
                        </li>
                        <li>
                          <div className="book">
                            ...
                            <div className="book-title">Harry Potter and the
                              Sorcerer's Stone
                            </div>
                      ...
                      <ol className="books-grid">
                        ...
                        <li>
                          <div className="book">
                            ...
                            <div className="book-title">Oh, the Places You'll
                              Go!
                            </div>
                        ...
                        <li>
                          <div className="book">
                            ...
                            <div className="book-title">The Adventures of Tom
                              Sawyer
                            </div>
              ...
              <div className="open-search">
                <button
                    onClick={() => setShowSearchPage(true)}>Add
                  a book
                </button>
              </div>
            </div>
